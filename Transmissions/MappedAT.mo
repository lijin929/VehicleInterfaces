...
model MappedAT "Mapped gear ratio, automatic transmission, no torque converter"
...
equation
  ...
  connect(RatioTable.y[1], idealGear.ratio) annotation(
    Line(points = {{-17, 60}, {-8, 60}, {-8, 32}, {-49, 32}, {-49, 8}, {-42, 8}}, color = {0, 0, 127}));
  connect(idealGear.support, mounting1D.flange_b) annotation(
    Line(points = {{-30, -10}, {-30, -50}}));
  connect(RatioTable.u, transmissionBus.gearCMD) annotation(
    Line(points = {{-40, 60}, {-56, 60}, {-56, 88}}, color = {0, 0, 127}));
  annotation(
