...
model ConventionalAutomaticVehicle_MappedEngine
  "Conventional automatic transmission vehicle"
  extends Modelica.Icons.Example;

  replaceable Engines.MappedEngine engine(engineSpeed_start = 800) 
...
end ConventionalAutomaticVehicle_MappedEngine;
